...
module Netzke::Basepack::DataAdapters
  ...
  class ActiveRecordAdapter < AbstractAdapter
    ...
    def get_records(params, columns=[])
      ...
      # merge grouping and sorting parameters
      group_and_sort_params = (params[:group] || []) + (params[:sort] || [])
      # apply sorting if needed
      group_and_sort_params.each do |sort_params|
        ...
        if a[:nested_attribute]
          ...
          if split.size == 2
            ...
            if assoc
              ...
              Rails.logger.debug "Netzke::Basepack: Association #{assoc} is not known for class #{@data_class}"
            end
          else
